...
export default function AuthResetPage() {
  ...
  if (!isSupabaseConfigured()) {
    return (
      <div className="flex min-h-dvh w-full flex-col bg-[#0f1419]">
        <div className="flex flex-1 flex-col justify-center px-6 py-12 text-zinc-200">
      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 text-zinc-200">
        <div className="mx-auto flex w-full max-w-md flex-col gap-6">
          ...
          <p className="text-sm text-zinc-400">
            Use the link from your email to reach this page, then choose a new password.
          </p>
